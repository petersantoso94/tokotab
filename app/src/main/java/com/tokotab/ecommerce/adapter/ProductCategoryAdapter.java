...
/**
 * Created by DIDLPSANTOSO on 6/29/2016.
 */
public class ProductCategoryAdapter extends RecyclerView.Adapter<ProductCategoryAdapter.ProductHolder> {
    private List<Produk> produkList = new ArrayList<>();
    private Context mContext;

    public ProductCategoryAdapter(List<Produk> produkList, Context context) {
        mContext = context;
    ...
    @Override
    public ProductCategoryAdapter.ProductHolder onCreateViewHolder(ViewGroup parent, int viewType) {
