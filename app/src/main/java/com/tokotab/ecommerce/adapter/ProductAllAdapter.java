...
/**
 * Created by DIDLPSANTOSO on 6/28/2016.
 */
public class ProductAllAdapter extends RecyclerView.Adapter<ProductAllAdapter.ProductHolder> {

    //g dipakai mContext
    private Context mContext;
    private List<Produk> produkList = new ArrayList<>();

    public ProductAllAdapter(Context mContext, List<Produk> produkList) {
    ...
    @Override
    public ProductAllAdapter.ProductHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_cardview_all, parent, false);
...
//                .load("http://home.stationeryone.com/uploaded_img/200x200/"+produk.getProductPicture1())
